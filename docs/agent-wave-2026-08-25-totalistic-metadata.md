...
six-bit rule encoding, rule, steps, rendered width, seed index, fixed-dead
boundary behavior, and the generated history. The default CLI still emits the
raw history JSON and does not write files.
